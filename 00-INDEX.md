...
**Local is behind remote by:** 18 commits (as of last check)
...
- Student PDFs in public GitHub repo (legal/DPDPA violation)
- Weak credentials in production `.env`
- 6 bugs in admission flow (issue #233)
- Localhost fallback URLs in 4 frontend files
