...
export default function AttendanceReport() {
  ...
  const [collegeInfo, setCollegeInfo] = useState({ name: "", code: "" });
  ...
  const printReport = () => {
    ...
    const collegeName =
      report.college?.name !== "N/A"
        ? report.college?.name
        : collegeInfo?.name || "N/A";
    const collegeCode =
      report.college?.code !== "N/A"
        ? report.college?.code
        : collegeInfo?.code || "N/A";
      ...
      >
        <div style={{ maxWidth: "100%", margin: "0 auto" }}>
            ...
            >
              ...
              >
                ...
                <span style={{ color: "#1e293b", fontWeight: 500 }}>
                  Use filters to generate custom reports. Data updates in
                  real-time based on your selections.
                </span>
              </div>
              <motion.button
                whileHover={{ scale: 1.05 }}
          ...
          >
            ...
            >
              <FaChartBar style={{ color: BRAND_COLORS.primary.main }} /> Report
              Summary
            </h3>
              ...
              <SummaryCard
                ...
                trend={
                  summary.totalPresent > 0
                    ? `+${Math.round((summary.totalPresent / (summary.totalPresent + summary.totalAbsent || 1)) * 100)}%`
                    : "0%"
                }
              />
              <SummaryCard
                ...
                trend={
                  summary.totalAbsent > 0
                    ? `-${Math.round((summary.totalAbsent / (summary.totalPresent + summary.totalAbsent || 1)) * 100)}%`
                    : "0%"
                }
              />
            </div>
          ...
          >
            ...
            >
              ...
              >
                <FaListUl style={{ color: BRAND_COLORS.primary.main }} />{" "}
              ...
              >
                <FaInfoCircle /> {sessions.length} session
              ...
              >
                <thead>
                  ...
                  >
                    ...
                    <th style={headerCellStyle} className="text-success">
                      Present
                    </th>
                    <th style={headerCellStyle} className="text-danger">
                      Absent
                    </th>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          ...
                          Make sure you have conducted sessions within the
                          selected date range.
                        </p>
                      </td>
                    </tr>
            ...
            {sessions.length > 0 && (
              ...
              >
                <div style={{ color: "#64748b", fontSize: "0.95rem" }}>
                  ...
                  {sessions.length !== 1 ? "s" : ""} displayed • Last updated:{" "}
